            ...
            <div className="container mx-auto px-6 sm:px-8 lg:px-20 py-16 text-[#5B3767]">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-stretch space-y-10 lg:space-y-0">
                    ...
                    <div
                        ...
                        <p className="font-garamond500"><span className="font-infant600 font-bold text-2xl">3-5</span>% no darījuma summas.</p>
                        <p className="font-garamond500">Īres darījumiem:</p>
                        <p className="font-garamond500">viena mēneša īres maksas apmērā</p>
                    </div>
                </div>
